sap.ui.require([
  ...
  var sViewName = "tutorial2.flphomepage.view.MainView";
      ...
      assertions: {
          ...
          iShouldSeeTheTitle: function () {
            return this.waitFor({
              ...
              properties: {
                text: "Title of tutorial2.flphomepage"
              },
              success: function() {
                Opa5.assert.ok(true, "The page shows the correct title");
              },
              errorMessage: "App does not show the expected title tutorial2.flphomepage"
            });
        }
      }
